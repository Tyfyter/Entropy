...
namespace Entropy {
    public class DmgCalcs {
        ...
        public static Func<float,NPC,float>[] dmgFuncs = new Func<float,NPC,float>[]{Slash,Impact,Puncture,Cold,Electric,Heat,Toxic,Blast,Corrosive,Gas,Magnetic,Radiation,Viral,True,Void};
