    ...
    public class BuffBase{
        ...
        public static BuffBase GetFromIndex(NPC npc, int type, int dmg){
            switch (type){
                ...
                case 1:
                return new ImpactEffect(npc, 15);
                case 2:
                npc.StrikeNPC(dmg/4, 0, 0, false);
                return new PuncEffect(npc, 360);
                case 3:
                return new ColdEffect(npc, 360);
                case 4:
                return new ElecEffect(npc, dmg/2, 1);
                case 5:
                return new HeatEffect(npc, dmg/2, 360);
                case 6:
                return new ToxicEffect(npc, dmg/2, 360);
                case 7:
                return new BlastEffect(npc, npc.boss?10:30);
                case 8:
                return new CorrEffect(npc, 30);
                case 9:
                return new GasEffect(npc, dmg/2, 360);
                case 12:
